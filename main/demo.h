...
// Voice Jump(main/demo_voice_jump.c): Voice-controlled parkour game
void demo_voice_jump_enter(void); void demo_voice_jump_exit(void);
void demo_voice_jump_key(bsp_btn_t btn, bsp_btn_ev_t ev);
esp_err_t demo_voice_jump_start(void); esp_err_t demo_voice_jump_stop(void);
